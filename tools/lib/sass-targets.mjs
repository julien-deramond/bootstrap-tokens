...
export const COMPONENTS = [
  ...
  { name: 'calendar', sassMap: '$calendar-tokens', file: 'scss/_calendar.scss', selector: '[data-vc=calendar]' },
  ...
  { name: 'datepicker', sassMap: '$datepicker-tokens', file: 'scss/_datepicker.scss', selector: '[data-vc=calendar][data-vc-input]' },
