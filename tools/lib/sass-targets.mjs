...
export const GROUPS = [
  ...
  // `hint` beats the name-based guess: every key of $theme-borders is a color, while
...
export const SCALARS = [
  ...
  { path: 'strength.transition', sassVar: '$strength-transition', cssVar: null, layer: 'component' },
...
export const COMPONENTS = [
  ...
  { name: 'button-styled', sassMap: '$button-styled-tokens', file: 'scss/buttons/_button.scss', selector: '.btn-styled', variantOf: 'btn' },
  ...
  { name: 'check', sassMap: '$check-tokens', file: 'scss/forms/_check.scss', selector: '.check' },
  { name: 'chip', sassMap: '$chip-tokens', file: 'scss/_chip.scss', selector: '.chip' },
  { name: 'collapse', sassMap: '$collapse-tokens', file: 'scss/_transitions.scss', selector: '.collapse' },
  { name: 'chip-input', sassMap: '$chip-input-tokens', file: 'scss/forms/_chip-input.scss', selector: '.chip-input' },
  { name: 'datepicker', sassMap: '$datepicker-tokens', file: 'scss/_datepicker.scss', selector: '[data-vc=calendar]' },
  ...
  { name: 'form-label', sassMap: '$form-label-tokens', file: 'scss/forms/_labels.scss', selector: '.form-label', inert: true },
  ...
  { name: 'input-group-addon', sassMap: '$input-group-addon-tokens', file: 'scss/forms/_input-group.scss', selector: '.input-group' },
  ...
  { name: 'otp', sassMap: '$otp-tokens', file: 'scss/forms/_otp-input.scss', selector: '.otp' },
  ...
  { name: 'placeholder-wave', sassMap: '$placeholder-wave-tokens', file: 'scss/_placeholder.scss', selector: '.placeholder-wave', variantOf: 'placeholder' },
  ...
  { name: 'radio', sassMap: '$radio-tokens', file: 'scss/forms/_radio.scss', selector: '.radio' },
  ...
  { name: 'switch', sassMap: '$switch-tokens', file: 'scss/forms/_switch.scss', selector: '.switch' },
  { name: 'table', sassMap: '$table-tokens', file: 'scss/content/_tables.scss', selector: '.table' },
  { name: 'tab-pane', sassMap: '$tab-pane-tokens', file: 'scss/_nav.scss', selector: '.tab-content > .tab-pane', variantOf: 'nav' },
